...
| `release/08-h110.0.2-s120.0.1` | 110.0.2 | 120.0.1 | ✅ | [zip](https://github.com/kittiphun-rut/MCUPR-CANTEEN/archive/refs/heads/release/08-h110.0.2-s120.0.1.zip) | [ล่าสุดของ branch นี้](https://github.com/kittiphun-rut/MCUPR-CANTEEN/tree/release/08-h110.0.2-s120.0.1) | **แก้ให้คอมไพล์ผ่าน Arduino IDE** — เพิ่ม forward declaration ที่ขาดสองจุด ฟีเจอร์เท่ากับ `release/07` ทุกอย่าง<br><sub>22 ก.ย. 2026</sub> |
