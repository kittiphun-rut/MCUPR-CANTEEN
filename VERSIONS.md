...
release/29-h113.10.0-s122.12.0
release/30-h113.11.0-s122.12.0
release/31-h113.12.0-s122.12.0
```
...
| `release/25-h113.8.0-s122.8.0` | 113.8.0 | 122.8.0 | ❔ | [zip](https://github.com/kittiphun-rut/MCUPR-CANTEEN/archive/refs/heads/release/25-h113.8.0-s122.8.0.zip) | [`b79d6cd`](https://github.com/kittiphun-rut/MCUPR-CANTEEN/tree/b79d6cd90f94ebd72aff44d127f0c4084f2cd295) | **เปลี่ยนคำว่า Point เป็น Station ทั้งจอและหน้าเว็บ** ให้ตรงกับชื่อไฟล์ ตัวแปร และโปรโตคอล · ร้านค้ายังใช้คำว่า Shop เหมือนเดิม · คำไทยไม่เปลี่ยน<br><sub>23 ก.ย. 2026</sub> |

| `release/26-h113.8.0-s122.9.0` | 113.8.0 | 122.9.0 | ❔ | [zip](https://github.com/kittiphun-rut/MCUPR-CANTEEN/archive/refs/heads/release/26-h113.8.0-s122.9.0.zip) | [`232306b`](https://github.com/kittiphun-rut/MCUPR-CANTEEN/tree/232306b04efe35e5b66da13b5ef4eb4fed884b3a) | **ขีดสัญญาณมุมขวาบนของจุดบริการหายหลังเปลี่ยนหน้า** เพราะแถบบนล้างพื้นแล้วไม่วาดคืน · ตัดตัวเลข dBm และคำว่า OFFLINE ออก เหลือแต่สัญลักษณ์ ตอนขาดการเชื่อมต่อโครงขีดเป็นสีแดง<br><sub>23 ก.ย. 2026</sub> |
...
| `release/29-h113.10.0-s122.12.0` | 113.10.0 | 122.12.0 | ❔ | [zip](https://github.com/kittiphun-rut/MCUPR-CANTEEN/archive/refs/heads/release/29-h113.10.0-s122.12.0.zip) | [`b0a1038`](https://github.com/kittiphun-rut/MCUPR-CANTEEN/tree/b0a103853a161a30234107607d4a896d70ece210) | **หน้าแรกบอกสถานะก่อนนิสิตแตะบัตร** SERVER OFFLINE คลื่นเหลือง และไม่รับการแตะบัตร · แยกหน้าเตือน "ไม่ทราบผล" ออกจาก "ไม่สำเร็จ" เพราะคำตอบอาจหายหลังแม่ข่ายบันทึกแล้ว<br><sub>24 ก.ย. 2026</sub> |

| `release/30-h113.11.0-s122.12.0` | 113.11.0 | 122.12.0 | ❔ | [zip](https://github.com/kittiphun-rut/MCUPR-CANTEEN/archive/refs/heads/release/30-h113.11.0-s122.12.0.zip) | [`1476746`](https://github.com/kittiphun-rut/MCUPR-CANTEEN/tree/14767466e75d0571bb4a2c72fb70c03fb55ed4fc) | **บันทึกสำเนาลงการ์ด SD หลังโมดูลจอ** รายการประจำวัน ไฟล์ปิดยอด และทะเบียนนิสิต · LittleFS ยังเป็นที่เก็บหลัก ไม่มีการ์ดก็ทำงานได้ครบ · **ต้องเดินสายเพิ่มสี่เส้น**<br><sub>24 ก.ย. 2026</sub> |

| `release/31-h113.12.0-s122.12.0` | 113.12.0 | 122.12.0 | ❔ | [zip](https://github.com/kittiphun-rut/MCUPR-CANTEEN/archive/refs/heads/release/31-h113.12.0-s122.12.0.zip) | [`515f9e4`](https://github.com/kittiphun-rut/MCUPR-CANTEEN/tree/515f9e4355204bc8e575e4cbaa2de2c3423772fe) | **การ์ด SD ย้ายไปบัส HSPI ของตัวเอง** ไม่ใช้ร่วมกับจอ · สี่ขาเรียงติดกันที่ตำแหน่ง 6 ถึง 9 เดินสายหนึ่งต่อหนึ่งไม่ต้องแยกสาย · **ใช้แทน `release/30`**<br><sub>24 ก.ย. 2026</sub> |

> ❔ **`release/12` ถึง `release/31` ยังไม่ผ่านการคอมไพล์จริง**
...
> ℹ️ **`release/30` ใช้บัส SPI ร่วมกับจอ** ซึ่งใช้งานได้แต่ต้องต่อสายสองเส้น
> เข้าหัวต่อเดียวกัน ใช้ **`release/31`** แทน ซึ่งแยกบัสของการ์ดออกมา
> เดินสายหนึ่งต่อหนึ่ง ฟีเจอร์เท่ากันทุกอย่าง
