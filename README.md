...
|---|---|---|
| `Canteen_Host_Server/` | เครื่องแม่ข่าย: ฐานข้อมูลนิสิต, RTC, เว็บพอร์ทัล, เครื่องพิมพ์สลิป | 109.0.0 |
| `Canteen_Station_Client/` | เครื่องลูกข่ายประจำร้านค้า: อ่านบัตร RFID แล้วถามสิทธิ์จากแม่ข่าย | 119.0.0 |
...
ภาพหน้าจอทั้งหมด 32 ภาพอยู่ใน [`docs/interface/`](docs/interface/) และเปิดดูรวมกันได้ที่
