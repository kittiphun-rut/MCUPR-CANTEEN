...
> 📌 **ย้อนกลับไปใช้เวอร์ชันเก่า** — ทุกรุ่นของทั้งสองฝั่งถูกชี้ตำแหน่งไว้พร้อมเลขคอมมิต
> ที่ [`VERSIONS.md`](VERSIONS.md) · **ต้นฉบับก่อนแก้ไข** เก็บไว้ครบที่ [`original/`](original/)
