...
> **ข้อจำกัดที่ต้องรู้:** ระหว่างที่ขาดการเชื่อมต่อ สถานีแต่ละเครื่องไม่รู้ว่าอีกเครื่องจ่ายใครไปแล้ว
> ถ้านิสิตคนเดียวกันไปแตะสองร้านในช่วงนั้นจะได้อาหารสองจาน ระบบจะจับได้ตอนซิงค์
> และขึ้นเป็นรายการที่ถูกปฏิเสธบนจอสรุปของสถานี พร้อมปรากฏในบันทึกให้เจ้าหน้าที่ตรวจสอบย้อนหลัง
