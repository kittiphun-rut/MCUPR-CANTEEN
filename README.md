...
├── HostScreen.h                 ทุกอย่างที่วาดลงจอ TFT ของแม่ข่าย           (647 บรรทัด)
└── WebDashboard.h               หน้าเว็บทั้งหมด: CSS, JavaScript, HTML      (709 บรรทัด)

Canteen_Station_Client/
├── Canteen_Station_Client.ino   ตรรกะระบบ อ่านบัตร ESP-NOW ปุ่มกด          (1,141 บรรทัด)
└── StationScreen.h              ทุกอย่างที่วาดลงจอ TFT ของจุดบริการ          (707 บรรทัด)
```
